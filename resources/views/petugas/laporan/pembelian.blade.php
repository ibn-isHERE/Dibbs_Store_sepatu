...
<div class="card mb-3">
    <div class="card-body">
        <form action="{{ route('petugas.laporan.pembelian') }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('petugas.laporan.pembelian') }}" class="btn btn-secondary">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        @if($pembelians->count() > 0)
        <a href="{{ route('petugas.laporan.pembelian.pdf', request()->all()) }}" 
