...
<div class="card mb-3">
    <div class="card-body">
        <form action="{{ route('petugas.laporan.stok-barang') }}" method="GET" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('petugas.laporan.stok-barang') }}" class="btn btn-secondary">
                        <i class="bi bi-x-circle"></i> Reset
                    </a>
                    <a href="{{ route('petugas.laporan.stok-barang.pdf', request()->all()) }}" 
