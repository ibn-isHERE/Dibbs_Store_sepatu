...
class LaporanController extends Controller
{
    ...
    public function stokBarang(Request $request)
    {
        ...
        return view('petugas.laporan.stok-barang', compact('barangs', 'kategoris'));
    }
    ...
    public function exportStokPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('petugas.laporan.pdf.stok-barang', compact('barangs'));
    ...
    public function pembelian(Request $request)
    {
        ...
        return view('petugas.laporan.pembelian', compact('pembelians', 'suppliers', 'totalPembelian', 'totalItem'));
    }
    ...
    public function exportPembelianPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('petugas.laporan.pdf.pembelian', compact('pembelians', 'totalPembelian'));
